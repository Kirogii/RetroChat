...
| --- | --- | --- | --- |
| /help | `/?` | Opens the local scrollable command-reference window. | - |
...
| /filter | - | Sets or displays the local message filter preference. | args: One of strict, default, relaxed, or off. Empty args displays current setting. |
| /theme | - | Changes the complete chat-window appearance and remembers it. | args: One of default, 2014, 2016, or 2018. |
